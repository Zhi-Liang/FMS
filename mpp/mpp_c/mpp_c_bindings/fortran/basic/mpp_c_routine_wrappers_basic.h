...
/*Header file for mpp_c_util_basic methods.*/
#ifndef SET_MPP_C_ROUTINE_WRAPPERS_BASIC_H_
#define SET_MPP_C_ROUTINE_WRAPPERS_BASIC_H_
...
void mpp_c_broadcast_wrap(void **,
                          size_t const,
                          int32_t,
                          int32_t const,
                          int32_t const *,
...
int64_t mpp_c_chksum_wrap(void *,
                          size_t const,
                          size_t const,
                          int8_t const,
                          void *,
...
void mpp_c_gather_pelist_wrap(void **,
                              size_t const,
                              size_t const,
                              size_t const,
                              int32_t const,
...
void mpp_c_scatter_pelist_wrap(void **,
                               size_t const,
                               size_t const,
                               size_t const,
                               int32_t const,
...
void mpp_c_alltoallv_wrap(void *,
                          int32_t *,
                          int32_t *,
                          void **,
                          int32_t *,
