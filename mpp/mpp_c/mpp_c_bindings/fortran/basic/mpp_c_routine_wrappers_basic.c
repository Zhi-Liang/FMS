...
#include "mpp_c_routine_wrappers_basic.h"
...
{
    return mpp_c_context_add_new_timer(context,timer_name,timer_name_len,
...
/*---------------------------------------------------------------------------*/
/*Send a message.*/
void mpp_c_send_wrap(void **send_data,
                     ...
                     mpp_c_context_t * const * const context)
{
    ...
    {
        mpp_c_send(send_data,send_len,to_rank,mpp_type,
                   tag,NULL,context);
    }
    else
    {
...
/*---------------------------------------------------------------------------*/
/*Receive a message.*/
void mpp_c_recv_wrap(void **recv_data,
                     ...
                     mpp_c_context_t * const * const context)
{
    if (*request == MPP_C_NULL_REQUEST)
    {
        mpp_c_recv(recv_data,recv_len,from_rank,mpp_type,
...
/*---------------------------------------------------------------------------*/
/*Broadcast a message.*/
void mpp_c_broadcast_wrap(void **bcast_data,
                          ...
                          mpp_c_context_t * const * const context)
{
    if (rank_list[0] == MPP_C_NULL_RANK_LIST)
    {
        mpp_c_broadcast(bcast_data,bcast_len,from_rank,
...
void mpp_c_sum_wrap(void **sum_data,
                    ...
                    mpp_c_context_t * const * const context)
{
    ...
    {
        mpp_c_sum(sum_data,sum_len,mpp_type,rank_list,
...
void mpp_c_max_wrap(void **max_data,
                    ...
                    mpp_c_context_t * const * const context)
{
    ...
    {
        mpp_c_max(max_data,max_len,mpp_type,rank_list,
                  rank_list_size,context);
    }
...
void mpp_c_min_wrap(void **min_data,
                    ...
                    mpp_c_context_t * const * const context)
{
    ...
    {
        mpp_c_min(min_data,min_len,mpp_type,rank_list,
                  rank_list_size,context);
    }
...
int64_t mpp_c_chksum_wrap(void *chksum_data,
                          ...
                          mpp_c_context_t * const * const context)
{
    ...
    if (rank_list[0] == MPP_C_NULL_RANK_LIST)
    {
        if (mask_flag)
        {
            chksum_val = mpp_c_chksum(chksum_data,chksum_len,
                                      num_bytes,mask_val,NULL,
                                      0,context);
        }
        else
        {
...
void mpp_c_gather_wrap(void *send_data,
                       size_t const send_len,
                       void **recv_data,
                       size_t const recv_len,
                       int32_t const mpp_type,
                       ...
                       mpp_c_context_t * const * const context)
{
    if (rank_list[0] == MPP_C_NULL_RANK_LIST)
    {
        mpp_c_gather(send_data,send_len,recv_data,
...
void mpp_c_gatherv_wrap(void *send_data,
                        size_t const send_len,
                        void **recv_data,
                        ...
                        mpp_c_context_t * const * const context)
{
    if (rank_list[0] == MPP_C_NULL_RANK_LIST)
    {
        mpp_c_gatherv(send_data,send_len,recv_data,
...
/*Perform a generalized gather of array segments across all ranks on a rank
  list.*/
void mpp_c_gather_pelist_wrap(void **gather_data,
                              ...
                              mpp_c_context_t * const * const context)
{
    mpp_c_gather_pelist(gather_data,gather_data_x_size,
                        gather_data_y_size,gather_data_z_size,mpp_type,
                        array_segment,gather_spot_x_start_index,
...
/*Perform a generalized scatter of array segments across all ranks on a rank
  list.*/
void mpp_c_scatter_pelist_wrap(void **scatter_data,
                               ...
                               mpp_c_context_t * const * const context)
{
    mpp_c_scatter_pelist(scatter_data,scatter_data_x_size,
...
void mpp_c_alltoall_wrap(void *send_data,
                         size_t const send_len,
                         void **recv_data,
                         size_t const recv_len,
                         ...
                         mpp_c_context_t * const * const context)
{
    if (rank_list[0] == MPP_C_NULL_RANK_LIST)
    {
        mpp_c_alltoall(send_data,send_len,recv_data,
...
void mpp_c_alltoallv_wrap(void *send_data,
                          int32_t *send_len,
                          ...
                          mpp_c_context_t * const * const context)
{
    if (rank_list[0] == MPP_C_NULL_RANK_LIST)
    {
        mpp_c_alltoallv(send_data,send_len,send_displace,
                        recv_data,recv_len,
